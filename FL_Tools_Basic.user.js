...
(function () {
  ...
  const FL_TOOLS_ICON_SVG = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 64 64\" role=\"img\" aria-label=\"FL Tools\"><rect x=\"2\" y=\"2\" width=\"60\" height=\"60\" rx=\"14\" fill=\"#24262b\"/><rect x=\"6\" y=\"6\" width=\"52\" height=\"52\" rx=\"11\" fill=\"none\" stroke=\"#747982\" stroke-width=\"2\"/><path fill=\"#ff4f86\" d=\"M32 52C25 45 12 38 12 27c0-6 4-10 9-10 4 0 8 3 11 7 3-4 7-7 11-7 5 0 9 4 9 10 0 11-13 18-20 25Z\"/><path fill=\"#fff\" fill-rule=\"evenodd\" d=\"M39 25.5l3 .2v4.6l-3 .2c-.2.7-.5 1.3-.8 1.9l2 2.2-3.3 3.3-2.2-2c-.6.3-1.2.6-1.9.8l-.2 3h-4.6l-.2-3c-.7-.2-1.3-.5-1.9-.8l-2 2-3.3-3.3 2-2.2c-.3-.6-.6-1.2-.8-1.9l-3-.2v-4.6l3-.2c.2-.7.5-1.3.8-1.9l-2-2.2 3.3-3.3 2.2 2c.6-.3 1.2-.6 1.9-.8l.2-3h4.6l.2 3c.7.2 1.3.5 1.9.8l2-2 3.3 3.3-2 2.2c.3.6.6 1.2.8 1.9ZM34 28a3.2 3.2 0 1 0-6.4 0A3.2 3.2 0 0 0 34 28Z\"/></svg>";
